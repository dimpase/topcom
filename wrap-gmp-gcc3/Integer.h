...
#define _POLYMAKE_GMP_INTEGER_H "$Project: polymake $$Id: Integer.h,v 1.4 2003/01/27 09:24:46 bzframba Exp $"
...
public:
   ...
   friend bool abs_equal(const Integer& a, long b) {
     ...
     return !mpz_cmpabs_ui(a.rep, long(std::abs(Integer(b))));
     // end jr.
     //////////////////////////////////////////////////////////////////////////////
   }
...
public:
   ...
   */
   ...
   struct div_t;
  //////////////////////////////////////////////////////////////////////////////
  // in older gcc versions the nested class must be a friende in order to 
  // have access to private members 
  // 2003/01/24 jr:
   friend struct Integer::div_t;
  // end jr.
  //////////////////////////////////////////////////////////////////////////////
};
