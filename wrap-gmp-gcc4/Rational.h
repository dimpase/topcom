...
#define _POLYMAKE_GMP_RATIONAL_H "$Project: polymake $$Id: Rational.h,v 1.6 2006/03/20 15:55:46 btmw01 Exp $"

#if defined(__GNUC__) && __GNUC__==3 && __GNUC_MINOR__<3 && !defined(__APPLE__) && !defined(__COMO__)
#pragma interface
#endif
...
#if defined(POLYMAKE_WITH_GMP_XX)
