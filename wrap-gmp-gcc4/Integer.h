...
#define _POLYMAKE_GMP_INTEGER_H "$Project: polymake $$Id: Integer.h,v 1.5 2006/03/20 15:55:46 btmw01 Exp $"
...
struct numeric_limits<Integer> : numeric_limits<long> {
   ...
   static const int digits=LONG_MAX;
   static const int digits10=LONG_MAX;
